...
impl Mul for BitMatrix8x8 {
    ...
    fn mul(self, rhs: Self) -> Self {
        ...
        let mut rows: [u8; 8] = [0; 8];
        let this = self.0.as_ptr() as *const u64;
        let rhs = rhs.0.as_ptr() as *const u64;
        let mul = rows.as_mut_ptr() as *mut u64;
...
mod tests {
    ...
    fn mul_8x8() {
        ...
        println!("matrix = \n{}", matrix);
        println!("other = \n{}", other);
        println!("identity = \n{}", BitMatrix8x8::IDENTITY);
        println!("matrix * other = \n{}", matrix * other);
        println!("matrix * identity = \n{}", matrix * BitMatrix8x8::IDENTITY);
        // let expect = BitMatrix8x8([
        //     0b1111_1111,
        //     0b1111_1110,
        //     0b1111_1100,
        //     0b1111_1000,
